...
|---|---|---|---|
| cautious | alpha: direct human-rated exposure | current observed rate, no projection | lowest verified mixed-program completion rate |
| central | beta: direct exposure plus half-weighted complementary-tool exposure | current anchor plus same-income-group historical 10-year increase, capped at 0.8 | main estimate from the mixed program set |
| fast | zeta: direct plus full complementary-tool exposure | projection rule with the historical 75th-percentile increase | highest verified mixed-program completion rate |
...
| TASK-FILTER | Task-share scale factor | 0.14 | 0.14 / 0.30 / 0.46 | Eloundou et al. (2023), arXiv:2303.10130, sections 3.3 and 4.1 | Share of tasks exposed within an occupation; source uses core-task double weighting | working figure | Use one human-rated construct family: alpha / beta / zeta means. These are scale factors, not probabilities. This supersedes the plan's category-level 0.50 central substitution. |
...
| ADOPT-ID-CURRENT | Indonesia current artificial-intelligence use | judgment value | 0.10 / 0.33 / 0.50 | No source; author-approved judgment values after source search | Scale factor applied to the emerging-market flagged share | unanchored | No direct Indonesia artificial-intelligence adoption figure exists in the approved sources. These values are reasoning-only scenario filters and must be foregrounded as unanchored. |
| DIFFUSION-CENTRAL | Same-income-group historical ten-year diffusion increase | pending | pending / pending / pending | Comin and Hobijn (2010); World Development Indicators internet-use series as approved fallback | Technology adoption share over a ten-year interval | working figure | Use World Development Indicators internet use for the number once extracted. It is consumer diffusion, not firm adoption, and is a scenario speed anchor rather than a forecast. Do not apply the advanced-economy increase to Indonesia. |
| FORMAL-US | United States formal share of realized harm | 0.93 | 0.93 / 0.93 / 0.93 | Author-approved fallback; ILOSTAT United States informality figure not yet verified | Employment; working figure range 0.90-0.95 | working figure | Use 0.93 centrally and record the 0.90-0.95 working range. Do not describe the number as a sourced observation. |
...
| PAY-IDN-RAW | Account ownership measure retained as payment-access proxy | 51.7553% | 51.7553% / 51.7553% / 51.7553% | World Bank Global Financial Inclusion Database API, indicator `FX.OWN.TOTL.ZS`, 2021 | Adults aged 15 and older | well-sourced | Author approved this as the conditional second choice if the government-payment-receipt measure is not extractable, after same-year United Nations World Population Prospects adult-share conversion and with the required downward-bias note. |
...
- The Census Business Trends and Outlook Survey static data page confirms that expanded employment-size tabulations exist and links the survey dashboard, but the direct XLSX/CSV file links are not exposed in the static response available here. No United States employment-weighted rate has been promoted.
- The World Bank Microdata Library catalog is reachable, but ordinary catalog searches did not surface the 2021 Identification for Development/Findex study. No identification or comparator median value has been promoted from an unverified catalog result.
